// Размер и место окна между запусками (1.16.0). Тот же модуль, что в калькуляторах
// (Calculators: calcpro-glass/window-state.js), и то же правило, что WindowPlacement в
// WPF-версии Paint Pro.
//
