...
// изменении.
//
// На GitHub публикуется только Electron-версия, поэтому C#-часть истории туда не едет.
// Границу задаёт метка в общем файле, а не догадка по номерам: номера у версий свои у
