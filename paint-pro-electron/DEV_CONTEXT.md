...
20. **Убирать «весь белый» вместо «белого фона».** Кеинг прозрачности проходом по всем пикселям пробивает дыры внутри картинки — блик на фото, белую заливку фигуры, — и сквозь них видно нижний слой. Заливка от краёв области внутрь снимает фон вокруг рисунка и не трогает белое внутри.

21. **`dragleave` как сигнал «курсор покинул окно».** Событие стреляет и при переходе между дочерними элементами, поэтому подсветка зоны drop гаснет и залипает как попало. Считать глубину: `dragenter` увеличивает счётчик, `dragleave` уменьшает, гасить на нуле.
